...
public class PositiveTestSuiteSuite extends BaseTestSuite {
    private Convertor.ConvertorTypes type;
    private float expected;
    private int convertData;

    public PositiveTestSuiteSuite(Convertor.ConvertorTypes type, int convertData, float expected) {
        this.type = type;
    ...
    public static Collection coverterData() {
        return Arrays.asList(new Object[][] {
                { Convertor.ConvertorTypes.FROM_KM_TO_L, 358, 42.95f},
                { Convertor.ConvertorTypes.FROM_KILLOGRAMM_TO_GRAMM, 1000, 1000000},
                { Convertor.ConvertorTypes.FROM_METERS_TO_KILOMETERS, 1000, 1 }
        });
    }
